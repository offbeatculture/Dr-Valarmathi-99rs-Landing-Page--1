...
export const CoachSectionGa = () => {
  const combines = [
    "modern nervous system science",
    "breath-based regulation techniques",
    "and ancient body-energy mapping (chakras)",
  ];
      ...
      <div className="container mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        ...
        <div className="order-2 lg:order-1">
          <div className="relative max-w-md mx-auto w-full">
            ...
            {/* Certificate block */}
            <div className="mt-5">
              <div className="rounded-2xl border border-[#E9E4D6] bg-white shadow-[0_8px_24px_rgba(0,0,0,0.06)] p-3 sm:p-4">
        ...
        <div className="order-1 lg:order-2 space-y-6">
          <div>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="inline-flex items-center rounded-full bg-[#0F2925] text-white text-xs md:text-sm px-3 py-1">
                Creator of the Breath Chakra Reset Method
              </span>
              <span className="inline-flex items-center rounded-full bg-[#0F2925] text-white text-xs md:text-sm px-3 py-1">
                Certified Nervous System Regulation &amp; Breath Coach
              </span>
            </div>
            ...
            <p className="mt-4 text-[#312B24]/80 md:text-lg leading-relaxed">
              ...
              health, reset their energy, and reclaim their best selves—using a
            ...
            {/* "Her work combines" list */}
            <div className="mt-3 rounded-2xl border border-[#E9E4D6] bg-white/60 p-4 shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
              <ul className="space-y-2 text-[#312B24]">
                {combines.map((item) => (
                  <li key={item} className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#175B53] mt-0.5 shrink-0" />
                    <span className="text-sm md:text-base">{item}</span>
                  </li>
                ))}
              </ul>

              <p className="mt-4 text-sm md:text-base text-[#312B24]/80 leading-relaxed">
                to create practical, measurable change in how people feel — often
                in a single session.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-[#0F2925] text-white shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
              ...
              <p className="text-xs sm:text-sm font-medium leading-snug">
                Expert in Body-Mind Connection
              </p>
            </div>
