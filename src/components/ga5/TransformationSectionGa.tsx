...
export const TransformationSectionGa = () => {
  const beforeItems = [
    "Racing thoughts even at rest",
    "Digestive discomfort & body tension",
    "Waking up tired and heavy",
    "Past memories on loop",
  ...
  const afterItems = [
    ...
    "Emotional lightness & clarity",
    "Relaxed body, steady energy",
  ];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-10 lg:mb-14">
          ...
          <p className="mt-3 text-[#312B24]/70 text-base md:text-lg max-w-2xl mx-auto">
            See the powerful shift from chaos to clarity in one powerful session.
          </p>
        </div>
